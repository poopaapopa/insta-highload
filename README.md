...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **`users`** | **6 млрд** | 380 | 130 *(id, email, phone, username)* | **2.28** | **3.00** |
| **`user_stats`** | **6 млрд** | 52 | 30 *(user_id)* | **0.31** | **0.43** |
| **`posts`** | **40 млрд** | 440 | 60 *(id, user_id)* | **17.60** | **19.80** |
| **`post_stats`** | **40 млрд** | 48 | 30 *(post_id)* | **1.92** | **2.72** |
| **`stories`** | **790 млрд** | 190 | 60 *(id, user_id)* | **150.10** | **181.60** |
| **`comments`** | **800 млрд** | 302 | 60 *(id, post_id)* | **241.60** | **273.60** |
| **`comment_stats`**| **800 млрд** | 48 | 30 *(comment_id)* | **38.40** | **54.40** |
| **`post_likes`** | **7.7 трлн** | 56 | 90 *(id, post_id, user_id)* | **392.17** | **854.38** |
| **`comment_likes`**| **1.2 трлн** *(800 млрд. комментариев × 1.5)* | 56 | 60 *(id, comment_id)* | **61.12** | **109.14** |
| **`follows`** | **1.6 трлн** | 70 | 90 *(id, follower, followee)* | **101.86** | **197.90** |
| **`chats`** | **90 млрд** *(6 млрд × 15 чатов)* | 58 | 30 *(id)* | **4.75** | **6.55** |
| **`chat_participants`**| **100 млрд** *(90 млрд чатов × 1.1)* | 56 | 90 *(id, chat_id, user_id)* | **5.09** | **11.10** |
| **`messages`** | **220 трлн** | 232 | 44 *(id, chat_id)* | **46,420.61** | **55,224.52** |
| **`search_index`** | **126 млрд** *(6 млрд юзеров + 120 млрд постов)* | 150 | 130 *(id, GIN для текста)* | **17.19** | **32.09** |
| **`sessions`** | **2 млрд** | 202 | 44 *(id, access_token)* | **0.40** | **0.45** |
